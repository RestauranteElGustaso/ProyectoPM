package com.example.entregadecomida.Adapters;
...
import com.example.entregadecomida.DBHelper;
import com.example.entregadecomida.DetailActivity;
import com.example.entregadecomida.Models.OrdersModel;
import com.example.entregadecomida.R;
...
public class OrdersAdapter extends RecyclerView.Adapter<OrdersAdapter.viewHolder> {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                alerta.setMessage("¿Quieres eliminar los datos?");
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        ImageView orderImage, add, subtract;
        TextView soldItemName, orderNumber, price, quantity;
